...
png("../plot2.png") # Opening the graphic device - png file, saving it in the original Working Directory. 
plot(plotdata$PTime, plotdata$Global_active_power, type = "l", xlab = "", ylab="Global Active Power (kilowatts)") # Creating the refrence plot.
